...
using static IndianStateCensusAnalyzer.CensusAnalyzer;
...
namespace CensualAnalyerTest
{
    public class Tests
    {
        ...
        static string delimiterIndianCensusFilePath = @"E:\dotnet\indiaCensus\IndianStateCensusAnalyser\IndianStateCensusAnalyzer\CensualAnalyerTest\CSVFiles\DelimiterIndiaStateCensusData.csv";
